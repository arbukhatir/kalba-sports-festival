...
window.KALBA_MAP = {
  ...
  zones: [
    ...
    { id: 'tennis', nameAr: 'حلبة التنس الأرضي', nameEn: 'Tennis Court',
      x: 22.2, y: 46.0, category: 'sports', icon: 'flag',
      descAr: 'منافسات التنس الأرضي على الملعب المسيّج غرب أرض المهرجان.',
      descEn: 'Tennis competition on the fenced court at the west of the grounds.',
      hours: '16:00–21:00', status: 'open', capacity: 150,
      schedule: [{ t: '17:00', ar: 'تصفيات الفردي', en: 'Singles heats' }] },

    { id: 'jiujitsu', nameAr: 'حلبة الجوجيتسو', nameEn: 'Jiu-Jitsu Arena',
      x: 29.1, y: 47.6, category: 'sports', icon: 'martial',
    ...
    { id: 'taekwondo', nameAr: 'حلبة التايكوندو', nameEn: 'Taekwondo Arena',
      x: 35.0, y: 47.2, category: 'sports', icon: 'martial',
