...
<section class="container section">
  <div class="grid g2">
    <?php
    $blocks = [
      ['🏟️', A('١٥ رياضة معتمدة', '15 official sports'), A('من كرة القدم والطائرة الشاطئية إلى الجوجيتسو والكاياك، منافسات رسمية بأربع فئات.', 'From beach football and volleyball to jiu-jitsu and kayak — official competitions across four categories.')],
